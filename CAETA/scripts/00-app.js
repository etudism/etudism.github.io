import { THREE, OrbitControls } from './lib/01-deps.js';
import { DATA } from './01-data.js';
import { installGlobalErrorHandlers } from './core/01-errors.js';
import { getDomRefs } from './core/02-dom.js';
import { normalizeBoothId, escapeHtml, normalizeSearchText } from './utils/01-id.js';
import { groupKeyFromMesh, uniqueValidBoothIds as baseUniqueValidBoothIds, selectedGroupKeysFrom as baseSelectedGroupKeysFrom } from './utils/02-groups.js';
import { searchIndexTextForMesh as baseSearchIndexTextForMesh, searchScoreForMesh, searchResultsForQuery as baseSearchResultsForQuery } from './features/01-search-utils.js';
import { normalizeCategoryLabel, colorForCategoryLabel as baseColorForCategoryLabel, buildCategoryLegendEntries } from './features/05-category-utils.js';
import { buildStatePayload as makeStatePayload, buildShareUrl as makeShareUrl, parseStateFromUrl as parseUrlState } from './features/08-url-state.js';
import { fmtMeta as formatMeshMeta } from './features/03-meta-utils.js';
import { setupTexturesAndLabels } from './visuals/01-textures-and-labels.js';
import { setupHallArchitecture } from './visuals/02-hall-architecture.js';
import { setupLayoutAndOverlay } from './visuals/03-layout-and-overlay.js';
import { setupSelectionCore } from './features/04-selection-core.js';
import { setupCategoryLayer } from './features/06-category-layer.js';
import { setupDrawer } from './features/07-drawer.js';
import { setupPersistence } from './features/09-persistence.js';
import { setupActionMenu } from './features/10-action-menu.js';
import { setupSearchUi } from './features/02-search-ui.js';
